...
export function createDropdown(props: ButtonProps, css?: CSS) {
  ...
  const Item = forwardRef<any, any>(({ children, ...rest }, ref) => (
    <DropdownMenuItem {...(propsRest as any)} {...rest} ref={ref}>
      {children}
    </DropdownMenuItem>
  ));
  ...
  const Content = forwardRef<any, any>(({ children, ...rest }, ref) => (
    <DropdownMenuContent {...(propsRest as any)} {...rest} ref={ref}>
      {children}
    </DropdownMenuContent>
  ));
  ...
  const Trigger = ({ children }: { children: React.ReactNode }) => {
    return (
      <DropdownMenu.Trigger aria-label="Options" asChild>
        <Button
          {...propsRest}
