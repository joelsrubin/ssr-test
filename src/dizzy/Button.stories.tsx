...
export const All = () => (
  <Stack gap="2" x="start" x-items="start">
    ...
    <Button color="neutral" size="sm" typeSize="sm" variant="contained">
      I am the button text
    </Button>
    <Button
      color="neutral"
    ...
    <Button color="orange" size="sm" typeSize="sm" variant="contained">
      I am the button text
    </Button>
    ...
    <Button
      ...
      typeSize="xs"
      variant="outline"
      left={<HiFingerPrint size={16} />}
    >
      I am the button text
    </Button>
    <Button color="neutral" size="sm" typeSize="sm" variant="outline">
      I am the button text
    </Button>
    ...
    <Button
      ...
      typeSize="xs"
      variant="outline"
      right={<HiDocumentRemove size={16} />}
    >
      I am the button text
    </Button>
    <Button color="orange" size="sm" typeSize="sm" variant="outline">
      I am the button text
    </Button>
    <Button
      color="orange"
    ...
    <Button color="neutral" size="xs" typeSize="xs" variant="subtle">
      I am the button text
    </Button>
    <Button
      color="neutral"
    ...
    <Button color="blue" size="sm" typeSize="sm" variant="subtle">
      I am the button text
    </Button>
    ...
    <Button color="orange" size="md" typeSize="sm" variant="subtle">
      I am the button text
    </Button>
    <Button color="neutral" size="xs" typeSize="xs" variant="ghost">
      I am the button text
    </Button>
    <Button color="neutral" size="sm" typeSize="sm" variant="ghost">
      I am the button text
    </Button>
    <Button color="neutral" size="md" typeSize="sm" variant="ghost">
      I am the button text
    </Button>
    <Button
      color="blue"
